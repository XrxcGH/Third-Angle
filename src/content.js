...
const SLOTS = [
  ...
  ['attributions.software.body', 'attributions', 'rich',
    'Node, Express, and EJS, on SQLite through Node\'s built-in `node:sqlite`. Ordering uses `fractional-indexing` (CC0). Templates are composed by `express-ejs-layouts`. Uploads are parsed by `multer` and re-encoded by `sharp`, and PDFs are read by `pdfjs-dist`. Search is SQLite FTS5. There is no framework, no build step, and no analytics that sets a cookie.\n\nThe source is public at [github.com/XrxcGH/Third-Angle](https://github.com/XrxcGH/Third-Angle).'],
  ...
  ['home.meta.description', 'home', 'text',
    'Mechanical design, electrical, controls, software, fabrication, documentation, business, and teaching. One engineer, several projections.'],
  ['work.meta.title', 'work', 'line', 'Work'],
  ['work.meta.description', 'work', 'text',
    'Projects across mechanical, electrical, controls, software, fabrication, documentation, business, and teaching.'],
